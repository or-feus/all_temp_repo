...
class CAN_Serial:
    ...
    def chk_can_err(self, rcvmsg):
        ...
        can_err_dir = os.path.isdir("/home/user/canerr")
        lmb_err_dir = os.path.isdir("/home/user/lmberr")
        ...
        if rcvmsg:
            ...
            if rcvmsg[64] != 0:
                ...
                if lmb_err_dir == False:
                    os.mkdir("/home/user/lmberr")
                else :
                    pass

            if can_err_dir :
                os.rmdir("/home/user/canerr")
            else :
                pass
