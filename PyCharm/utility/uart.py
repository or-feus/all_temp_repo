...
class CAN_Serial:
    ...
    def chk_can_err(self, rcvmsg):
        ...
        can_err_dir = os.path.isdir("/home/user/jetson-inference/dbict/control/can_error")
        lmb_err_dir = os.path.isdir("/home/user/jetson-inference/dbict/control/lmb_error")

        print(f"rcvmsg: {rcvmsg}")
        if rcvmsg:
            ...
            if rcvmsg[64] != 0:
                ...
                if lmb_err_dir:
                    os.rmdir("/home/user/jetson-inference/dbict/control/lmb_error")
                else:
                    pass
                ...
                if lmb_err_dir == False:
                    os.mkdir("/home/user/jetson-inference/dbict/control/lmb_error")
                else:
                    pass

            if can_err_dir:
                os.rmdir("/home/user/jetson-inference/dbict/control/can_error")
            else:
                pass
            ...
            if self.ser_fail > 100:
                ...
                if can_err_dir == False:
                    os.mkdir("/home/user/jetson-inference/dbict/control/can_error")
                else:
                    pass
                if lmb_err_dir == False:
                    os.mkdir("/home/user/jetson-inference/dbict/control/lmb_error")
