...
const cv::Scalar default_COLOR = cv::Scalar(0xFF, 0xFF, 0xFF); // white
const cv::Scalar normal_COLOR = cv::Scalar(0x33, 0xFF, 0x33); // green
const cv::Scalar reverse_COLOR = cv::Scalar(0x33, 0x00, 0xFF); // red
